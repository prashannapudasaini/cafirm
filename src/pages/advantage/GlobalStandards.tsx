      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6 animate-up">
          <div className="space-y-12 text-lg text-gray-700 leading-relaxed">
            ...
            {/* Core Discussion */}
            <section>
              <h3 className="text-2xl font-bold text-primary-dark-blue mb-4">The Imperative of Quality</h3>
              <p className="mb-4">
            ...
            <section>
              <h3 className="text-2xl font-bold text-primary-dark-blue mb-4">Elevating the Nepalese Enterprise</h3>
              <p className="mb-4">
