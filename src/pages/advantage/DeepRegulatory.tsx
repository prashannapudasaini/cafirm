      ...
      <section className="py-20 bg-white dark:bg-[#020A1A]">
        <div className="max-w-4xl mx-auto px-6 animate-up">
          <div className="space-y-12 text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            {/* Core Discussion */}
            <section>
              <h3 className="text-2xl font-bold text-primary-dark-blue dark:text-white mb-4">The Complexity of Compliance</h3>
              <p className="mb-4">
            ...
            <section>
              <h3 className="text-2xl font-bold text-primary-dark-blue dark:text-white mb-4">Navigating the Nepalese Ecosystem</h3>
              <p className="mb-4">
