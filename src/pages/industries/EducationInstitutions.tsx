            ...
            <section>
              ...
              <ul className="space-y-6">
                <li className="flex items-start">
                  ...
                  <div>
                    <strong className="block text-primary-dark-blue mb-1">Corporate Structuring & Guthi Laws</strong>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <strong className="block text-primary-dark-blue mb-1">Revenue Leakage & Internal Controls</strong>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <strong className="block text-primary-dark-blue mb-1">Tax & SSF Compliance</strong>
            ...
            <section>
              ...
              <div className="space-y-4">
                <div className="p-6 bg-gray-50 rounded-xl border border-gray-100">
                  <h3 className="font-bold text-primary-dark-blue mb-2">Corporate Restructuring & M&A</h3>
                  <p className="text-gray-600 text-sm leading-relaxed">We architect the complex legal and financial restructuring of educational institutions. For expanding networks, we conduct exhaustive financial due diligence on target acquisitions, ensuring liabilities are correctly valued before purchase.</p>
                </div>
                <div className="p-6 bg-gray-50 rounded-xl border border-gray-100">
                  <h3 className="font-bold text-primary-dark-blue mb-2">Internal Audit & Revenue Assurance</h3>
                  <p className="text-gray-600 text-sm leading-relaxed">We conduct rigorous internal audits focused specifically on the fee-collection cycle. We reconcile student registers with bank deposits to eliminate cash leakage and recommend robust ERP integrations.</p>
                </div>
                <div className="p-6 bg-gray-50 rounded-xl border border-gray-100">
                  <h3 className="font-bold text-primary-dark-blue mb-2">Statutory Audit & Tax Advisory</h3>
                  <p className="text-gray-600 text-sm leading-relaxed">We provide comprehensive statutory audits that satisfy the Ministry of Education and the OCR. We also design highly efficient tax structures for promoters while ensuring absolute compliance with SSF and TDS regulations.</p>
                </div>
              </div>
            </section>
