  ...
  return (
    <div ref={containerRef} className="bg-white min-h-screen">
      ...
      <section className="relative bg-primary-dark-blue text-white pt-32 pb-20 lg:pt-40 lg:pb-32 overflow-hidden">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1544365558-35aa4afcf11f?q=80&w=2036&auto=format&fit=crop')] bg-cover bg-center opacity-10 mix-blend-luminosity"></div>
            ...
            <section>
              ...
              <ul className="space-y-6">
                <li className="flex items-start">
                  ...
                  <div>
                    <strong className="block text-primary-dark-blue mb-1">Complex Franchise & Management Contracts</strong>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <strong className="block text-primary-dark-blue mb-1">Asset Heavy Balance Sheets</strong>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <strong className="block text-primary-dark-blue mb-1">Revenue Recognition & Tax Leakage</strong>
            ...
            <section>
              ...
              <div className="space-y-4">
                <div className="p-6 bg-gray-50 rounded-xl border border-gray-100">
                  <h3 className="font-bold text-primary-dark-blue mb-2">Investment Structuring & Feasibility</h3>
                  <p className="text-gray-600 text-sm leading-relaxed">Before breaking ground, we conduct rigorous financial feasibility studies, stress-testing RevPAR (Revenue Per Available Room) assumptions against realistic debt-servicing costs to validate the investment thesis for banks and private equity partners.</p>
                </div>
                <div className="p-6 bg-gray-50 rounded-xl border border-gray-100">
                  <h3 className="font-bold text-primary-dark-blue mb-2">Cross-Border Tax Advisory</h3>
                  <p className="text-gray-600 text-sm leading-relaxed">We structure international franchise and management agreements to legally minimize Withholding Taxes (WHT) on royalties and technical fees, strictly adhering to Double Taxation Avoidance Agreements (DTAAs).</p>
                </div>
                <div className="p-6 bg-gray-50 rounded-xl border border-gray-100">
                  <h3 className="font-bold text-primary-dark-blue mb-2">Operational Internal Audits</h3>
                  <p className="text-gray-600 text-sm leading-relaxed">We conduct aggressive internal audits focused on revenue assurance. We reconcile property management systems (PMS) with financial ledgers to eliminate pilferage in F&B, optimize procurement supply chains, and verify statutory compliances like the Social Security Fund (SSF).</p>
                </div>
              </div>
            </section>
