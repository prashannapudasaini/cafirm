            ...
            <section>
              ...
              <ul className="space-y-6">
                <li className="flex items-start">
                  ...
                  <div>
                    <strong className="block text-primary-dark-blue mb-1">Inventory & Pharmacy Shrinkage</strong>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <strong className="block text-primary-dark-blue mb-1">Complex Doctor Compensation (TDS/VAT)</strong>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <strong className="block text-primary-dark-blue mb-1">CAPEX Valuation & Depreciation</strong>
            ...
            <section>
              ...
              <div className="space-y-4">
                <div className="p-6 bg-gray-50 rounded-xl border border-gray-100">
                  <h3 className="font-bold text-primary-dark-blue mb-2">Hospital Revenue & Inventory Audits</h3>
                  <p className="text-gray-600 text-sm leading-relaxed">We conduct specialized internal audits that reconcile Hospital Management Information Systems (HMIS) with financial ledgers. We perform surprise physical verifications of pharmacy stock to eliminate shrinkage and optimize procurement cycles.</p>
                </div>
                <div className="p-6 bg-gray-50 rounded-xl border border-gray-100">
                  <h3 className="font-bold text-primary-dark-blue mb-2">Pharma Cost Accounting & Pricing</h3>
                  <p className="text-gray-600 text-sm leading-relaxed">For pharmaceutical manufacturers, we build precise cost-accounting models. We accurately allocate overheads and active pharmaceutical ingredient (API) costs, allowing management to price competitively while defending margins against government price caps.</p>
                </div>
                <div className="p-6 bg-gray-50 rounded-xl border border-gray-100">
                  <h3 className="font-bold text-primary-dark-blue mb-2">Tax & Transfer Pricing Advisory</h3>
                  <p className="text-gray-600 text-sm leading-relaxed">We structure highly defensible transfer pricing policies for multinational pharma subsidiaries. For hospitals, we design tax-efficient doctor compensation models and ensure absolute compliance with Health Service Tax exemptions.</p>
                </div>
              </div>
            </section>
