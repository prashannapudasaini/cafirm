        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="max-w-3xl animate-up">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-semibold mb-6 leading-tight">
              Insolvency & <br />
              <span className="text-royal-blue">Liquidation</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 animate-up">
              ...
              <h3 className="text-xl font-bold text-primary-dark-blue mb-4">Creditor Pressure</h3>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 animate-up">
              ...
              <h3 className="text-xl font-bold text-primary-dark-blue mb-4">Director Liability</h3>
              <p className="text-gray-600 leading-relaxed text-sm">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 animate-up">
              ...
              <h3 className="text-xl font-bold text-primary-dark-blue mb-4">Bureaucratic Gridlock</h3>
              <p className="text-gray-600 leading-relaxed text-sm">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="space-y-16">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center animate-up">
              <div>
                <h3 className="text-2xl font-bold text-primary-dark-blue mb-4">Corporate Restructuring & Turnaround</h3>
                ...
                <ul className="space-y-3">
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 font-medium">Strategic Purpose:</span> Prevent bankruptcy and preserve enterprise value through aggressive financial re-engineering.</li>
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 font-medium">Use Case:</span> Negotiating a debt-to-equity swap with a syndicate of banks for a distressed manufacturing firm.</li>
                </ul>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center animate-up">
              ...
              <div className="order-1 lg:order-2">
                <h3 className="text-2xl font-bold text-primary-dark-blue mb-4">Official Liquidator Services</h3>
                <p className="text-gray-600 leading-relaxed mb-6">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 font-medium">Strategic Purpose:</span> Ensure a legally compliant winding-down process that shields directors from future liability.</li>
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 font-medium">Use Case:</span> Managing the voluntary liquidation of a foreign IT subsidiary exiting the Nepalese market.</li>
                </ul>
              </div>
            </div>
          </div>
