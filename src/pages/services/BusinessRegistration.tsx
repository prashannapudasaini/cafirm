        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="max-w-3xl animate-up">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-semibold mb-6 leading-tight">
              ...
              <span className="text-royal-blue">Establishing Robust Foundations</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 animate-up">
              ...
              <h3 className="text-xl font-bold text-primary-dark-blue mb-4">Restrictive Foundations</h3>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 animate-up">
              ...
              <h3 className="text-xl font-bold text-primary-dark-blue mb-4">Compliance Paralysis</h3>
              <p className="text-gray-600 leading-relaxed text-sm">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="space-y-16">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center animate-up">
              <div>
                <h3 className="text-2xl font-bold text-primary-dark-blue mb-4">Strategic Entity Structuring & Incorporation</h3>
                ...
                <ul className="space-y-3">
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 font-medium">Strategic Purpose:</span> Establish a resilient, legally sound foundation designed explicitly for scale and capital acquisition.</li>
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 font-medium">Client Benefits:</span> Prevents future legal bottlenecks, protects founder equity, and accelerates go-to-market timelines across all regulatory agencies (OCR, IRD, Ward).</li>
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 font-medium">Use Case:</span> Technology startups preparing for future venture capital rounds, or foreign entities establishing local subsidiaries.</li>
                </ul>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center animate-up">
              ...
              <div className="order-1 lg:order-2">
                <h3 className="text-2xl font-bold text-primary-dark-blue mb-4">Outsourced Corporate Secretarial Services</h3>
                <p className="text-gray-600 leading-relaxed mb-6">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 font-medium">Strategic Purpose:</span> Eliminate the administrative burden of compliance while ensuring absolute statutory perfection.</li>
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 font-medium">Client Benefits:</span> Shields directors from legal liabilities, prevents compounding OCR fines, and ensures the company is perpetually 'audit-ready'.</li>
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 font-medium">Use Case:</span> Established SMEs and corporate groups requiring dedicated compliance management without the overhead of an in-house legal team.</li>
                </ul>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center animate-up">
              <div>
                <h3 className="text-2xl font-bold text-primary-dark-blue mb-4">Shareholder Management & Corporate Alterations</h3>
                <p className="text-gray-600 leading-relaxed mb-6">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 font-medium">Strategic Purpose:</span> Facilitate corporate agility while ensuring structural changes are legally binding and tax-efficient.</li>
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 font-medium">Client Benefits:</span> Prevents disputes during ownership transitions and mitigates unintended tax consequences (e.g., Section 57 liabilities).</li>
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 font-medium">Use Case:</span> Companies executing a buyout of a founding partner or bringing on external investors.</li>
                </ul>
              </div>
              <div className="bg-gray-100 rounded-2xl aspect-[4/3] overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  <h4 className="text-lg font-bold text-primary-dark-blue">OCR Administrative Precedence</h4>
                  <p className="text-sm text-gray-600 mt-1 leading-relaxed">
                ...
                <div>
                  <h4 className="text-lg font-bold text-primary-dark-blue">Cross-Agency Compliance</h4>
                  <p className="text-sm text-gray-600 mt-1 leading-relaxed">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-16 animate-up">
            ...
            <p className="text-gray-600">Expert answers to your corporate structuring and compliance inquiries.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gray-50 p-8 rounded-2xl border border-gray-100 flex flex-col justify-between group cursor-pointer animate-up">
              <div>
                ...
                <p className="text-sm text-gray-600 mb-6">If your existing corporate structure is hindering growth, engage our senior advisors for comprehensive corporate restructuring and holding company formation.</p>
              </div>
            ...
            <div className="bg-gray-50 p-8 rounded-2xl border border-gray-100 flex flex-col justify-between group cursor-pointer animate-up">
              <div>
                <span className="text-xs font-bold text-royal-blue uppercase tracking-wider mb-2 block">Related Service</span>
                <h3 className="text-xl font-bold text-primary-dark-blue mb-4 group-hover:text-royal-blue transition-colors">FDI & Investment Advisory</h3>
                <p className="text-sm text-gray-600 mb-6">For foreign investors, corporate registration is only one piece of the puzzle. We manage the entire FITTA framework to ensure seamless market entry.</p>
              </div>
              <Link to="/services/fdi-and-investment" className="inline-flex items-center text-sm font-bold text-primary-dark-blue group-hover:text-royal-blue transition-colors">
                Explore Service <ArrowRight className="ml-2 w-4 h-4 transform group-hover:translate-x-1 transition-transform" />
              </Link>
            </div>
          </div>
