        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="max-w-3xl animate-up">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-semibold mb-6 leading-tight">
              BPO & Payroll <br />
              <span className="text-[#a5caff]">Management</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-[#020A1A] p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-white/10 animate-up">
              ...
              <h3 className="text-xl font-bold text-primary-dark-blue dark:text-white mb-4">Compliance Penalties</h3>
            ...
            <div className="bg-white dark:bg-[#020A1A] p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-white/10 animate-up">
              ...
              <h3 className="text-xl font-bold text-primary-dark-blue dark:text-white mb-4">Loss of Executive Focus</h3>
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-sm">
            ...
            <div className="bg-white dark:bg-[#020A1A] p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-white/10 animate-up">
              ...
              <h3 className="text-xl font-bold text-primary-dark-blue dark:text-white mb-4">Confidentiality Risks</h3>
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-sm">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="space-y-16">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center animate-up">
              <div>
                <h3 className="text-2xl font-bold text-primary-dark-blue dark:text-white mb-4">End-to-End Payroll & SSF</h3>
                ...
                <ul className="space-y-3">
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 dark:text-gray-300 font-medium">Strategic Purpose:</span> Eliminate payroll errors, guarantee compliance, and maintain absolute confidentiality.</li>
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 dark:text-gray-300 font-medium">Use Case:</span> Managing payroll for a 200+ employee tech firm with diverse contract structures.</li>
                </ul>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center animate-up">
              ...
              <div className="order-1 lg:order-2">
                <h3 className="text-2xl font-bold text-primary-dark-blue dark:text-white mb-4">Accounting & Bookkeeping</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 dark:text-gray-300 font-medium">Strategic Purpose:</span> Maintain pristine, audit-ready financials without the overhead of an internal finance team.</li>
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 dark:text-gray-300 font-medium">Use Case:</span> Full-service bookkeeping for a foreign IT subsidiary operating in Nepal.</li>
                </ul>
              </div>
            </div>
          </div>
