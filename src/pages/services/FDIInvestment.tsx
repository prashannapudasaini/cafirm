        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="max-w-3xl animate-up">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-semibold mb-6 leading-tight">
              FDI & Investment: <br />
              <span className="text-[#a5caff]">Facilitating Seamless Market Entry</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-[#031B4E] p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-white/10 animate-up">
              ...
              <h3 className="text-xl font-bold text-primary-dark-blue dark:text-white mb-4">Multi-Agency Friction</h3>
            ...
            <div className="bg-white dark:bg-[#031B4E] p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-white/10 animate-up">
              ...
              <h3 className="text-xl font-bold text-primary-dark-blue dark:text-white mb-4">Repatriation Roadblocks</h3>
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-sm">
            ...
            <div className="bg-white dark:bg-[#031B4E] p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-white/10 animate-up">
              ...
              <h3 className="text-xl font-bold text-primary-dark-blue dark:text-white mb-4">Structuring Vulnerabilities</h3>
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-sm">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="space-y-16">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center animate-up">
              <div>
                <h3 className="text-2xl font-bold text-primary-dark-blue dark:text-white mb-4">FDI Route Planning & Structuring</h3>
                ...
                <ul className="space-y-3">
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 dark:text-gray-300 font-medium">Strategic Purpose:</span> Eliminate statutory roadblocks before they occur by aligning commercial objectives with legal realities.</li>
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 dark:text-gray-300 font-medium">Client Benefits:</span> Prevents wasted legal expenditures and ensures the ultimate corporate structure supports future capital repatriation.</li>
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 dark:text-gray-300 font-medium">Use Case:</span> A multinational technology firm evaluating the legal feasibility of establishing a development center in Kathmandu.</li>
                </ul>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center animate-up">
              ...
              <div className="order-1 lg:order-2">
                <h3 className="text-2xl font-bold text-primary-dark-blue dark:text-white mb-4">Multi-Agency Regulatory Approvals</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 dark:text-gray-300 font-medium">Strategic Purpose:</span> Cut through administrative inertia to secure binding legal approvals for capital injection.</li>
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 dark:text-gray-300 font-medium">Client Benefits:</span> Significantly accelerates project commencement and completely shields foreign executives from bureaucratic harassment.</li>
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 dark:text-gray-300 font-medium">Use Case:</span> An international hospitality group seeking to inject USD 10M for a new luxury resort.</li>
                </ul>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center animate-up">
              <div>
                <h3 className="text-2xl font-bold text-primary-dark-blue dark:text-white mb-4">Repatriation & Cross-Border Advisory</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 dark:text-gray-300 font-medium">Strategic Purpose:</span> Protect the ultimate financial objective of the foreign investor: yielding and repatriating returns.</li>
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 dark:text-gray-300 font-medium">Client Benefits:</span> Eliminates trapped liquidity risks and legally minimizes withholding taxes via DTAA utilization.</li>
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 dark:text-gray-300 font-medium">Use Case:</span> A foreign Private Equity firm seeking to repatriate dividends and management fees from its Nepalese portfolio company.</li>
                </ul>
              </div>
              <div className="bg-gray-100 dark:bg-[#131B33] rounded-2xl aspect-[4/3] overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-6">
                <div>
                  <h4 className="text-lg font-bold text-primary-dark-blue dark:text-white">The FITTA Framework</h4>
                ...
                <div>
                  <h4 className="text-lg font-bold text-primary-dark-blue dark:text-white">NRB Foreign Exchange Bylaws</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-400 mt-1 leading-relaxed">
                ...
                <div>
                  <h4 className="text-lg font-bold text-primary-dark-blue dark:text-white">Double Taxation Avoidance (DTAA)</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-400 mt-1 leading-relaxed">
      ...
      <section className="py-20 bg-gray-50 dark:bg-[#031B4E]">
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-16 animate-up">
            ...
            <p className="text-gray-600 dark:text-gray-400">Executive clarity on navigating foreign investment regulations in Nepal.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gray-50 dark:bg-[#031B4E] p-8 rounded-2xl border border-gray-100 dark:border-white/10 flex flex-col justify-between group cursor-pointer animate-up">
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-6">Ensure your cross-border transactions and dividend distributions are engineered for maximum tax efficiency under Nepalese law and relevant DTAAs.</p>
              </div>
            ...
            <div className="bg-gray-50 dark:bg-[#031B4E] p-8 rounded-2xl border border-gray-100 dark:border-white/10 flex flex-col justify-between group cursor-pointer animate-up">
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-6">Read our executive briefing on recent amendments to the FITTA guidelines and how they impact capital repatriation timelines for multinationals.</p>
              </div>
