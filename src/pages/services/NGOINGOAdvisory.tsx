        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="max-w-3xl animate-up">
            <div className="inline-flex items-center space-x-2 px-3 py-1 bg-white/10 border border-white/20 rounded-full text-sm font-semibold tracking-wide uppercase mb-6">
              <Users2 className="w-4 h-4 text-royal-blue" />
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-semibold mb-6 leading-tight">
              NGO / INGO <br />
              <span className="text-royal-blue">Advisory & Audit</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 animate-up">
              ...
              <h3 className="text-xl font-bold text-primary-dark-blue mb-4">SWC Scrutiny</h3>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 animate-up">
              ...
              <h3 className="text-xl font-bold text-primary-dark-blue mb-4">Donor Audits</h3>
              <p className="text-gray-600 leading-relaxed text-sm">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 animate-up">
              ...
              <h3 className="text-xl font-bold text-primary-dark-blue mb-4">Tax Misconceptions</h3>
              <p className="text-gray-600 leading-relaxed text-sm">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="space-y-16">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center animate-up">
              <div>
                <h3 className="text-2xl font-bold text-primary-dark-blue mb-4">SWC & Regulatory Compliance</h3>
                ...
                <ul className="space-y-3">
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 font-medium">Strategic Purpose:</span> Maintain flawless legal standing to ensure uninterrupted operations.</li>
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 font-medium">Use Case:</span> Preparing an INGO for its mandatory 5-year SWC comprehensive evaluation.</li>
                </ul>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center animate-up">
              ...
              <div className="order-1 lg:order-2">
                <h3 className="text-2xl font-bold text-primary-dark-blue mb-4">Donor-Specific Project Audits</h3>
                <p className="text-gray-600 leading-relaxed mb-6">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 font-medium">Strategic Purpose:</span> Secure continuous funding by demonstrating unimpeachable financial stewardship.</li>
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 font-medium">Use Case:</span> A financial verification audit for a multi-million dollar USAID grant.</li>
                </ul>
              </div>
            </div>
          </div>
