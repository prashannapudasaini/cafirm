        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="max-w-3xl animate-up">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-semibold mb-6 leading-tight">
              ...
              <span className="text-royal-blue">Quantifying True Enterprise Value</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 animate-up">
              ...
              <h3 className="text-xl font-bold text-primary-dark-blue mb-4">Hidden Liabilities</h3>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 animate-up">
              ...
              <h3 className="text-xl font-bold text-primary-dark-blue mb-4">Valuation Disconnects</h3>
              <p className="text-gray-600 leading-relaxed text-sm">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="space-y-16">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center animate-up">
              <div>
                <h3 className="text-2xl font-bold text-primary-dark-blue mb-4">Financial & Tax Due Diligence</h3>
                ...
                <ul className="space-y-3">
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 font-medium">Strategic Purpose:</span> Uncover material risks and validate historical EBITDA before capital is irrevocably committed.</li>
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 font-medium">Client Benefits:</span> Prevents disastrous acquisitions, protects post-merger shareholder value, and informs optimal deal structuring.</li>
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 font-medium">Use Case:</span> A Private Equity firm evaluating a multi-million dollar acquisition of a Nepalese manufacturing plant.</li>
                </ul>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center animate-up">
              ...
              <div className="order-1 lg:order-2">
                <h3 className="text-2xl font-bold text-primary-dark-blue mb-4">Enterprise & Equity Valuation</h3>
                <p className="text-gray-600 leading-relaxed mb-6">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 font-medium">Strategic Purpose:</span> Establish an authoritative financial baseline for negotiations, regulatory filings, or dispute resolution.</li>
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 font-medium">Client Benefits:</span> Maximizes exit multiples for sellers, prevents overpayment for buyers, and effortlessly passes NRB/DOI regulatory scrutiny.</li>
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 font-medium">Use Case:</span> Valuing a high-growth fintech startup for a Series B venture capital funding round.</li>
                </ul>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center animate-up">
              <div>
                <h3 className="text-2xl font-bold text-primary-dark-blue mb-4">Vendor Due Diligence (Sell-Side)</h3>
                <p className="text-gray-600 leading-relaxed mb-6">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 font-medium">Strategic Purpose:</span> Regain control of the M&A narrative by proactively addressing operational and financial vulnerabilities.</li>
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 font-medium">Client Benefits:</span> Prevents buyers from using discovered flaws to aggressively negotiate down the purchase price at the last minute.</li>
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 font-medium">Use Case:</span> A family-owned conglomerate preparing to divest a non-core subsidiary to a foreign institutional investor.</li>
                </ul>
              </div>
              <div className="bg-gray-100 rounded-2xl aspect-[4/3] overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-6">
                <div>
                  <h4 className="text-lg font-bold text-primary-dark-blue">NRB & DOI Mandates (FDI)</h4>
                ...
                <div>
                  <h4 className="text-lg font-bold text-primary-dark-blue">Income Tax Act (Section 57)</h4>
                  <p className="text-sm text-gray-600 mt-1 leading-relaxed">
                ...
                <div>
                  <h4 className="text-lg font-bold text-primary-dark-blue">Office of the Company Registrar (OCR)</h4>
                  <p className="text-sm text-gray-600 mt-1 leading-relaxed">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-16 animate-up">
            ...
            <p className="text-gray-600">Executive clarity on navigating complex corporate transactions.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gray-50 p-8 rounded-2xl border border-gray-100 flex flex-col justify-between group cursor-pointer animate-up">
              <div>
                ...
                <p className="text-sm text-gray-600 mb-6">Following a successful transaction, engage our advisory team to manage post-merger integration and corporate restructuring to realize anticipated synergies.</p>
              </div>
            ...
            <div className="bg-gray-50 p-8 rounded-2xl border border-gray-100 flex flex-col justify-between group cursor-pointer animate-up">
              <div>
                ...
                <h3 className="text-xl font-bold text-primary-dark-blue mb-4 group-hover:text-royal-blue transition-colors">Section 57: Mitigating Tax Risks During M&A</h3>
                <p className="text-sm text-gray-600 mb-6">Read our critical analysis of the Income Tax Act's Change in Control provisions and how buyers must protect themselves during Nepalese transactions.</p>
              </div>
