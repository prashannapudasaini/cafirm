        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="max-w-3xl animate-up">
            <div className="inline-flex items-center space-x-2 px-3 py-1 bg-white/10 dark:bg-[#020A1A]/10 border border-white/20 rounded-full text-sm font-semibold tracking-wide uppercase mb-6">
              <Calculator className="w-4 h-4 text-[#a5caff]" />
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-semibold mb-6 leading-tight">
              Tax & Regulatory: <br />
              <span className="text-[#a5caff]">Strategic Compliance & Optimization</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-[#020A1A] p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-white/10 animate-up">
              ...
              <h3 className="text-xl font-bold text-primary-dark-blue dark:text-white mb-4">Aggressive IRD Assessments</h3>
            ...
            <div className="bg-white dark:bg-[#020A1A] p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-white/10 animate-up">
              ...
              <h3 className="text-xl font-bold text-primary-dark-blue dark:text-white mb-4">Statutory Ambiguity</h3>
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-sm">
            ...
            <div className="bg-white dark:bg-[#020A1A] p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-white/10 animate-up">
              ...
              <h3 className="text-xl font-bold text-primary-dark-blue dark:text-white mb-4">Cross-Border Friction</h3>
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-sm">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="space-y-16">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center animate-up">
              <div>
                <h3 className="text-2xl font-bold text-primary-dark-blue dark:text-white mb-4">Strategic Corporate Tax Planning</h3>
                ...
                <ul className="space-y-3">
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 dark:text-gray-300 font-medium">Strategic Purpose:</span> Legally optimize the effective corporate tax rate while ensuring bulletproof statutory compliance.</li>
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 dark:text-gray-300 font-medium">Client Benefits:</span> Preserves working capital, enhances shareholder returns, and entirely eliminates the stress of year-end compliance shocks.</li>
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 dark:text-gray-300 font-medium">Use Case:</span> Pre-transaction structuring for mergers, or annual tax modeling for large-scale manufacturers.</li>
                </ul>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center animate-up">
              ...
              <div className="order-1 lg:order-2">
                <h3 className="text-2xl font-bold text-primary-dark-blue dark:text-white mb-4">IRD Assessment & Dispute Resolution</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 dark:text-gray-300 font-medium">Strategic Purpose:</span> Defend the enterprise against aggressive or miscalculated statutory assessments.</li>
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 dark:text-gray-300 font-medium">Client Benefits:</span> Prevents unjustified cash outflows, resolves disputes expediently, and shields management from administrative harassment.</li>
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 dark:text-gray-300 font-medium">Use Case:</span> Representation during Section 64 (Full Audit) assessments or contesting arbitrary administrative reviews.</li>
                </ul>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center animate-up">
              <div>
                <h3 className="text-2xl font-bold text-primary-dark-blue dark:text-white mb-4">VAT & Indirect Tax Advisory</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 dark:text-gray-300 font-medium">Strategic Purpose:</span> Ensure absolute transactional compliance while optimizing indirect tax cash flows.</li>
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 dark:text-gray-300 font-medium">Client Benefits:</span> Unlocks trapped VAT credits, prevents mismatch penalties, and streamlines monthly filing procedures.</li>
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 dark:text-gray-300 font-medium">Use Case:</span> Hydropower projects seeking VAT refunds or hospitals managing exempt vs. taxable supply complexities.</li>
                </ul>
              </div>
              <div className="bg-gray-100 dark:bg-[#131B33] rounded-2xl aspect-[4/3] overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-6">
                <div>
                  <h4 className="text-lg font-bold text-primary-dark-blue dark:text-white">The Income Tax Act 2058</h4>
                ...
                <div>
                  <h4 className="text-lg font-bold text-primary-dark-blue dark:text-white">Value Added Tax Act 2052</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-400 mt-1 leading-relaxed">
                ...
                <div>
                  <h4 className="text-lg font-bold text-primary-dark-blue dark:text-white">The Annual Finance Act</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-400 mt-1 leading-relaxed">
      ...
      <section className="py-20 bg-gray-50 dark:bg-[#0A1128]">
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-16 animate-up">
            ...
            <p className="text-gray-600 dark:text-gray-400">Expert guidance on Nepal’s most pressing tax and regulatory concerns.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gray-50 dark:bg-[#0A1128] p-8 rounded-2xl border border-gray-100 dark:border-white/10 flex flex-col justify-between group cursor-pointer animate-up">
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-6">Ensure your strategic growth initiatives, M&A activities, and corporate restructuring are inherently tax-efficient and legally sound.</p>
              </div>
            ...
            <div className="bg-gray-50 dark:bg-[#0A1128] p-8 rounded-2xl border border-gray-100 dark:border-white/10 flex flex-col justify-between group cursor-pointer animate-up">
              <div>
                ...
                <h3 className="text-xl font-bold text-primary-dark-blue dark:text-white mb-4 group-hover:text-royal-blue transition-colors">Annual Budget 2081/82: Business Impact Analysis</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-6">Read our executive summary on the latest amendments to the Finance Act and how they directly impact enterprise taxation in Nepal.</p>
              </div>
