        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="max-w-3xl animate-up">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-semibold mb-6 leading-tight">
              Risk & Compliance: <br />
              <span className="text-[#a5caff]">Safeguarding Enterprise Resilience</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-[#020A1A] p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-white/10 animate-up">
              ...
              <h3 className="text-xl font-bold text-primary-dark-blue dark:text-white mb-4">Regulatory Sanctions</h3>
            ...
            <div className="bg-white dark:bg-[#020A1A] p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-white/10 animate-up">
              ...
              <h3 className="text-xl font-bold text-primary-dark-blue dark:text-white mb-4">Operational Vulnerability</h3>
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-sm">
            ...
            <div className="bg-white dark:bg-[#020A1A] p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-white/10 animate-up">
              ...
              <h3 className="text-xl font-bold text-primary-dark-blue dark:text-white mb-4">Cyber & Data Exposure</h3>
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-sm">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="space-y-16">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center animate-up">
              <div>
                <h3 className="text-2xl font-bold text-primary-dark-blue dark:text-white mb-4">Enterprise Risk Management (ERM)</h3>
                ...
                <ul className="space-y-3">
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 dark:text-gray-300 font-medium">Strategic Purpose:</span> Transition the organization from reactive crisis management to proactive risk mitigation.</li>
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 dark:text-gray-300 font-medium">Client Benefits:</span> Drastically reduces earnings volatility and provides the Board with immense clarity regarding strategic threats.</li>
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 dark:text-gray-300 font-medium">Use Case:</span> Large conglomerates seeking to standardize risk protocols across diverse operating subsidiaries.</li>
                </ul>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center animate-up">
              ...
              <div className="order-1 lg:order-2">
                <h3 className="text-2xl font-bold text-primary-dark-blue dark:text-white mb-4">Internal Controls Design & Optimization</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 dark:text-gray-300 font-medium">Strategic Purpose:</span> Eliminate operational friction and structurally prevent financial leakage and internal fraud.</li>
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 dark:text-gray-300 font-medium">Client Benefits:</span> Immediately improves EBITDA margins and ensures financial data integrity for executive decision-making.</li>
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 dark:text-gray-300 font-medium">Use Case:</span> Manufacturing or trading firms experiencing unexplained inventory shrinkage or procurement anomalies.</li>
                </ul>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center animate-up">
              <div>
                <h3 className="text-2xl font-bold text-primary-dark-blue dark:text-white mb-4">AML/CFT & Regulatory Compliance Readiness</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 dark:text-gray-300 font-medium">Strategic Purpose:</span> Ensure absolute adherence to stringent national and international regulatory mandates.</li>
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 dark:text-gray-300 font-medium">Client Benefits:</span> Completely shields the enterprise and its directors from devastating civil and criminal regulatory sanctions.</li>
                  <li className="flex items-start"><CheckCircle2 className="w-5 h-5 text-royal-blue mr-3 shrink-0 mt-0.5"/> <span className="text-gray-700 dark:text-gray-300 font-medium">Use Case:</span> BFIs, insurance companies, real estate developers, and high-value dealers navigating FIU mandates.</li>
                </ul>
              </div>
              <div className="bg-gray-100 dark:bg-[#131B33] rounded-2xl aspect-[4/3] overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-6">
                <div>
                  <h4 className="text-lg font-bold text-primary-dark-blue dark:text-white">NRB Unified Directives</h4>
                ...
                <div>
                  <h4 className="text-lg font-bold text-primary-dark-blue dark:text-white">AML/CFT Act</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-400 mt-1 leading-relaxed">
                ...
                <div>
                  <h4 className="text-lg font-bold text-primary-dark-blue dark:text-white">Corporate Governance Directives</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-400 mt-1 leading-relaxed">
      ...
      <section className="py-20 bg-gray-50 dark:bg-[#0A1128]">
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-16 animate-up">
            ...
            <p className="text-gray-600 dark:text-gray-400">Expert guidance on mitigating enterprise risk and navigating complex compliance mandates.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gray-50 dark:bg-[#0A1128] p-8 rounded-2xl border border-gray-100 dark:border-white/10 flex flex-col justify-between group cursor-pointer animate-up">
              <div>
                ...
                <h3 className="text-xl font-bold text-primary-dark-blue dark:text-white mb-4 group-hover:text-royal-blue transition-colors">Audit & Assurance</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-6">Pair our proactive risk management frameworks with rigorous statutory and internal audit services to provide stakeholders with absolute transparency.</p>
              </div>
              <Link to="/services/audit-and-assurance" className="inline-flex items-center text-sm font-bold text-primary-dark-blue dark:text-white group-hover:text-royal-blue transition-colors">
            ...
            <div className="bg-gray-50 dark:bg-[#0A1128] p-8 rounded-2xl border border-gray-100 dark:border-white/10 flex flex-col justify-between group cursor-pointer animate-up">
              <div>
                ...
                <h3 className="text-xl font-bold text-primary-dark-blue dark:text-white mb-4 group-hover:text-royal-blue transition-colors">Navigating Nepal Rastra Bank's Evolving AML Directives</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-6">Read our executive briefing on the recent amendments to AML/CFT requirements and how DNFBPs must urgently adapt their compliance structures.</p>
              </div>
