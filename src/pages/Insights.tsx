      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1 space-y-8 animate-up">
            <h3 className="text-xl font-bold text-primary-dark-blue dark:text-white mb-6 pb-4 border-b border-gray-100 dark:border-white/10">Browse Topics</h3>
                  ...
                  <li key={cat.name}>
                    <Link to={cat.path} className="flex items-center justify-between p-4 rounded-xl hover:bg-blue-50 transition-colors group">
                      <div className="flex items-center">
                        ...
                        <span className="font-semibold text-primary-dark-blue dark:text-white">{cat.name}</span>
                      </div>
                      <span className="text-sm text-gray-500 dark:text-gray-400 font-medium bg-gray-100 dark:bg-[#131B33] px-3 py-1 rounded-full group-hover:bg-blue-100 group-hover:text-royal-blue transition-colors">
                        {cat.count}
                      </span>
                    </Link>
                  </li>
            ...
            <div className="bg-primary-dark-blue p-8 rounded-3xl mt-12 text-center relative overflow-hidden">
              ...
              <input type="email" placeholder="Your email address" className="w-full px-4 py-3 bg-white/10 dark:bg-[#020A1A]/10 border border-white/20 rounded-xl text-white placeholder-white/50 focus:outline-none focus:border-royal-blue mb-4 relative z-10" />
          ...
          <div className="lg:col-span-3 space-y-8">
            <div className="flex items-center justify-between mb-8 animate-up border-b border-gray-100 dark:border-white/10 pb-4">
              <h3 className="text-2xl font-bold text-primary-dark-blue dark:text-white">Latest Publications</h3>
              <button className="text-royal-blue font-semibold hover:text-primary-dark-blue dark:text-white transition-colors flex items-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {recentArticles.map((article, index) => (
                <div key={index} className="animate-up group cursor-pointer border border-gray-100 dark:border-white/10 rounded-3xl p-8 hover:border-royal-blue/30 hover:shadow-[0_8px_30px_rgb(0,0,0,0.04)] transition-all bg-white dark:bg-[#020A1A] flex flex-col justify-between h-full">
                  <div>
            ...
            <div className="pt-8 flex justify-center animate-up">
              <button className="px-8 py-4 bg-white dark:bg-[#020A1A] border border-gray-200 dark:border-white/20 text-primary-dark-blue dark:text-white rounded-xl font-bold hover:bg-gray-50 dark:bg-[#0A1128] hover:border-gray-300 transition-all shadow-sm">
                Load More Articles
              </button>
            </div>
