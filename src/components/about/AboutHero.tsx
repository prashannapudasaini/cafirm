...
const AboutHero = () => {
  ...
  return (
    <section
      ref={containerRef}
      className="relative min-h-[70vh] flex items-center pt-24 pb-12 overflow-hidden bg-gradient-to-br from-primary-dark-blue via-[#0a2f7a] to-white dark:to-[#031B4E]"
    >
      ...
      <div className="max-w-7xl mx-auto px-6 w-full grid grid-cols-1 lg:grid-cols-2 gap-12 relative z-10">
        ...
        <div ref={leftContentRef} className="flex flex-col justify-center">
          ...
          <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
            <Link to="/contact" className="px-8 py-4 bg-white dark:bg-[#031B4E] text-primary-dark-blue dark:text-white rounded-xl font-medium transition-all hover:scale-[1.02] active:scale-[0.98] shadow-lg flex items-center justify-center">
              Schedule Consultation
              <ArrowRight className="ml-2 w-5 h-5" />
            </Link>
            <Link to="/services" className="px-8 py-4 bg-white/10 dark:bg-[#031B4E]/10 backdrop-blur-md border border-white/20 text-white rounded-xl font-medium hover:bg-white/20 dark:bg-[#031B4E]/20 transition-all active:scale-[0.98] flex items-center justify-center">
              Explore Services
            </Link>
          </div>
        </div>
        ...
        <div ref={rightContentRef} className="relative hidden lg:flex items-center justify-center">
          ...
          <div className="floating-card floating-card-1 absolute top-[5%] -left-[5%] bg-white/80 dark:bg-[#031B4E]/80 backdrop-blur-xl border border-white/50 p-3 rounded-xl shadow-xl flex items-center space-x-3">
          ...
          <div className="floating-card floating-card-2 absolute top-[25%] -right-[5%] bg-primary-dark-blue/90 backdrop-blur-xl border border-white/20 p-3 rounded-xl shadow-xl flex items-center space-x-3">
            <div className="w-8 h-8 rounded-full bg-white/10 dark:bg-[#031B4E]/10 flex items-center justify-center">
              <FileText className="w-4 h-4 text-white" />
            </div>
            <p className="text-sm font-semibold text-white pr-2">Audit Reports</p>
          </div>

          <div className="floating-card floating-card-3 absolute bottom-[25%] -left-[10%] bg-white/90 dark:bg-[#031B4E]/90 backdrop-blur-xl border border-white/50 p-3 rounded-xl shadow-xl flex items-center space-x-3">
            <div className="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center">
