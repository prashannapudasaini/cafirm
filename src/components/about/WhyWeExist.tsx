...
const WhyWeExist = () => {
  ...
  return (
    <section ref={containerRef} className="py-8 md:py-10 bg-white relative z-10 px-6">
      <div className="max-w-6xl mx-auto">
        <div className="exist-panel relative rounded-[3rem] overflow-hidden shadow-[0_20px_80px_-20px_rgba(15,82,186,0.2)] bg-gradient-to-br from-white to-blue-50/50 border border-black/5">
