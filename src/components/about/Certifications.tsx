...
const Certifications = () => {
  ...
  return (
    <section ref={containerRef} className="py-8 md:py-10 bg-white relative">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="cert-content flex flex-col justify-center order-2 lg:order-1">
            ...
            <p className="text-lg text-gray-700 font-light mb-10 max-w-lg leading-relaxed">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {certifications.map((cert, idx) => (
                <div key={idx} className="flex items-center space-x-3 bg-gray-50 border border-gray-100 p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                  <div className="p-2 bg-white rounded-lg shadow-sm shrink-0">
                    {cert.icon}
                  </div>
                  <span className="text-sm font-semibold text-primary-dark-blue leading-snug">{cert.title}</span>
                </div>
              ))}
            </div>
          </div>

          <div className="cert-image relative w-full aspect-[4/3] rounded-[2rem] overflow-hidden shadow-2xl order-1 lg:order-2 border border-gray-100">
            <img 
            ...
            <div className="absolute top-6 right-6 w-20 h-20 bg-white/90 backdrop-blur-md rounded-full shadow-2xl flex items-center justify-center animate-[spin_10s_linear_infinite]">
