...
const Hero = () => {
  ...
  return (
    <section
      ref={containerRef}
      className="relative min-h-[95vh] flex items-center pt-24 pb-12 overflow-hidden bg-gradient-to-br from-primary-dark-blue via-[#0a2f7a] to-white dark:to-[#031B4E]"
    >
      {/* Subtle animated glass layers */}
      <div className="hero-glass absolute top-0 right-0 w-[50vw] h-[50vw] bg-white/10 dark:bg-[#031B4E]/10 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-6 w-full grid grid-cols-1 lg:grid-cols-[55%_45%] gap-12 lg:gap-8 relative z-10">
        ...
        <div ref={leftContentRef} className="flex flex-col justify-center pr-0 lg:pr-8">
          ...
          <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 mb-12">
            <Link to="/contact" className="px-8 py-4 bg-white dark:bg-[#031B4E] text-primary-dark-blue dark:text-white rounded-xl font-medium text-lg transition-all hover:scale-[1.02] active:scale-[0.98] shadow-lg flex items-center justify-center">
              Schedule Consultation
              <ArrowRight className="ml-2 w-5 h-5" />
            </Link>
            <Link to="/services" className="px-8 py-4 bg-white/10 dark:bg-[#031B4E]/10 backdrop-blur-md border border-white/20 text-white rounded-xl font-medium text-lg hover:bg-white/20 dark:bg-[#031B4E]/20 transition-all active:scale-[0.98] flex items-center justify-center">
              Explore Services
            </Link>
          </div>
        ...
        <div ref={rightContentRef} className="relative hidden lg:flex items-center justify-center pl-4">
          ...
          <div className="floating-card floating-card-1 absolute top-[15%] -left-[10%] bg-white/90 dark:bg-[#031B4E]/90 backdrop-blur-xl border border-white/50 p-4 rounded-xl shadow-xl flex items-center space-x-4">
          ...
          <div className="floating-card floating-card-2 absolute bottom-[25%] -right-[15%] bg-primary-dark-blue/90 backdrop-blur-xl border border-white/20 p-4 rounded-xl shadow-2xl flex items-center space-x-4">
            <div className="w-10 h-10 rounded-full bg-white/10 dark:bg-[#031B4E]/10 flex items-center justify-center shrink-0">
          ...
          <div className="floating-card floating-card-3 absolute top-[40%] -right-[10%] bg-white/90 dark:bg-[#031B4E]/90 backdrop-blur-xl border border-white/50 p-4 rounded-xl shadow-xl flex items-center space-x-4">
            <div className="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center shrink-0">
