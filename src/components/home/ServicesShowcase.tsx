    ...
    <section ref={sectionRef} className="py-10 md:py-12 bg-primary-dark-blue relative border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6">
          ...
          {displayServices.map((service, index) => (
            ...
            >
              <div className="relative h-48 overflow-hidden shrink-0">
                ...
                <div className="absolute bottom-4 left-4 w-12 h-12 bg-white/10 dark:bg-[#031B4E]/10 backdrop-blur-md rounded-xl flex items-center justify-center border border-white/20">
                  {service.icon}
                </div>
              </div>
        ...
        <div className="mt-10 md:hidden flex justify-center">
          <Link to="/services" className="inline-flex items-center px-6 py-3 bg-white/10 dark:bg-[#031B4E]/10 text-white rounded-lg hover:bg-white/20 dark:bg-[#031B4E]/20 transition-colors">
            View All Services
